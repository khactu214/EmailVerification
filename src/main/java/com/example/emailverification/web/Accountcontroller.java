package com.example.emailverification.web;

import com.example.emailverification.model.VerificationForm;
import com.example.emailverification.service.VerificationTokenService;
...
public class Accountcontroller {
    ...
    @GetMapping("/")
    public String index() {return "redirect:/email-verification";}
    @GetMapping("/email-verification")
    public String formGet(Model model) {
        model.addAttribute("verification-form",new VerificationForm());
